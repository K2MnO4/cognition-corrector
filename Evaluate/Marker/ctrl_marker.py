...
def calc_ctrl_score(file_path):
    ...
    scorer = CTRLEval(iwf_dir='Evaluate/CTRLEval/data/iwf_full.txt',
                        prompt_dir='Evaluate/CTRLEval/data/prompt_{}.txt'.format(task),
                        verbal_dir='Evaluate/CTRLEval/data/verbal_{}.txt'.format(task),
                        device=device)
    prefix_list = []
    data_list = []
